...
```json
{
  ...
  "schema": {
    ...
    "properties": {
      ...
      "actual_csat": {
        "type": ["integer", "null"],
        "description": "Actual CSAT from caller (1-5) or null if not provided"
      },
      "follow_up_needed": {
        "type": "boolean",
      ...
      "rag_performance": {
        ...
        "required": ["avg_kb_confidence", "total_citations", "citation_list", "modality_distribution", "vector_overlap_score"],
        "additionalProperties": false
      }
    },
    "additionalProperties": false,
    "required": ["call_id", "duration_seconds", "outcome", "primary_topic", "secondary_topics", "agents_activated", "issue_resolved", "robot_model", "product", "sentiment", "predicted_csat", "actual_csat", "follow_up_needed", "follow_up_action", "summary", "tags", "escalation_reason", "sales_lead_info", "ticket_info", "rag_performance"]
  }
}
```
